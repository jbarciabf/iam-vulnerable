...
resource "google_service_account" "privesc19_dataflow" {
...
resource "google_project_iam_member" "privesc19_dataflow" {
  project = var.project_id
  role    = "roles/dataflow.developer"
  member  = "serviceAccount:${google_service_account.privesc19_dataflow.email}"
}
...
resource "google_service_account_iam_member" "privesc19_impersonate" {
  service_account_id = google_service_account.privesc19_dataflow.name
