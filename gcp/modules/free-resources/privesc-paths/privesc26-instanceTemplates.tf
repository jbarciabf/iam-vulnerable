# Privesc Path 26: Instance Templates with Privileged SA
#
...
resource "google_service_account" "privesc26_instance_templates" {
...
resource "google_project_iam_custom_role" "privesc26_instance_templates" {
...
resource "google_project_iam_member" "privesc26_instance_templates" {
  project = var.project_id
  role    = google_project_iam_custom_role.privesc26_instance_templates.id
  member  = "serviceAccount:${google_service_account.privesc26_instance_templates.email}"
}
...
resource "google_service_account_iam_member" "privesc26_impersonate" {
  service_account_id = google_service_account.privesc26_instance_templates.name
