# Privesc Path 17: Deployment Manager
#
...
resource "google_service_account" "privesc17_deployment_manager" {
...
resource "google_project_iam_member" "privesc17_deployment" {
  project = var.project_id
  role    = "roles/deploymentmanager.editor"
  member  = "serviceAccount:${google_service_account.privesc17_deployment_manager.email}"
}
...
resource "google_service_account_iam_member" "privesc17_impersonate" {
  service_account_id = google_service_account.privesc17_deployment_manager.name
